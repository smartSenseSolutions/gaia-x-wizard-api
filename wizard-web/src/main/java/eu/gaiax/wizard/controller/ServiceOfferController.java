...
public class ServiceOfferController extends BaseController {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = {@Content(examples = {@ExampleObject(name = "Create Service offer", value = """
            {
            ...
            """)})})
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Service offering successfully.", content = {@Content(examples = {@ExampleObject(name = "Success Response", value = """
            {
              "status": 200,
              "payload": {
                "name": "name of service",
            ...
            """)})}), @ApiResponse(responseCode = "400", description = "Invalid (Participant,Dependence On,Aggregation of )", content = {@Content(examples = {@ExampleObject(name = "Validation failed", value = """
            {
...
*/
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Service offering successfully.", content = {@Content(examples = {@ExampleObject(name = "Success Response", value = """
            ...
            """)})}),})
    public void validateServiceOfferRequest(@RequestBody CreateServiceOfferingRequest request) throws IOException {
        //todo email changes remaining get from auth(String) this.requestForClaim("email", principal)
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = {@Content(examples = {@ExampleObject(name = "Filter request with sort", value = """
            {
              "page": 0,
              "size": 5,
              "sort": {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Master data fetched successfully.", content = {@Content(examples = {@ExampleObject(name = "Successful request", value = """
            {
               "status": 200,
               "payload": {
                 "content": [
