...
--changeset Neha:2
INSERT INTO format_type_master(type, active) VALUES
...
--changeset Neha:8
ALTER TABLE label_level_type_master DROP COLUMN IF EXISTS type;
...
--changeset Neha:9
DROP TABLE IF EXISTS label_level_question_master;
